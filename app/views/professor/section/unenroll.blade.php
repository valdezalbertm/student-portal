...
@section('body')
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
        <div class="col-lg-12">
            <h1>Section on Professor <small>Delete</small></h1>

            <!-- S: Breadcrumb -->
            <ol class="breadcrumb">
              <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li><a href="{{ route('prof.create') }}"><i class="fa fa-plus"></i> Create</a></li>
              <li><a href="{{ route('prof.index') }}"><i class="fa fa-list"></i> List</a></li>
            ...
            <div class="table-responsive">
                ...
                <p align="center">
                    Do you really want to delete section {{ $sec_id }} on professor {{ $prof_id }}?
                    <br /><br />

                    {{ Form::open( ['route' => ['prof_sec.destroy', $prof_id, $sec_id], 'method' => 'DELETE'] ) }}
                        <center>
