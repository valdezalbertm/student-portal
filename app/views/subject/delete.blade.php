...
@section('head')
    ...
    <title>{{ Session::get('account_type') }} - Delete Subject</title>
...
@section('body')
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
        <div class="col-lg-12">
            <h1>Subject <small>Delete</small></h1>
            ...
            <div class="table-responsive">
                ...
                <p align="center">
                    Do you really want to delete subject {{ $id }}?
                    <br /><br />
                    {{ Form::open( ['route' => ['subj.destroy', $id], 'method' => 'DELETE'] ) }}
                      <center>
