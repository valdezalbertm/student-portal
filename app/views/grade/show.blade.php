...
@section('body')
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>{{ $sec->name }} <small>Student List</small></h1>
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li><a href="{{ route('sec_stud.create', $sec->id) }}"><i class="fa fa-plus"></i> Register Student</a></li>
                            ...
                            <tbody>
                                @foreach ($studs as $stud)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('grade.encode', [$sec->id, $stud->student_id] ) }}" class='btn btn-info'><i class="fa fa-plus"></i> Encode</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
